const pokemonCards = [
  ...
  },
  {
    ...
    supertype: 'Trainer',
    rules: ['Your opponent shuffles his or her hand into his or her deck, then draws 7 cards.'],
    number: '73',
    artist: 'Ken Sugimori',
    rarity: 'Rare',
    legalities: {
  ...
  },
  {
    ...
    name: 'Full Heal',
    supertype: 'Trainer',
    rules: ['Your Active Pokémon is no longer Asleep, Confused, Paralyzed, or Poisoned.'],
    number: '82',
    artist: 'Keiji Kinebuchi',
    rarity: 'Uncommon',
    legalities: {
  ...
  },
  {
    ...
    name: 'Maintenance',
    supertype: 'Trainer',
    rules: ['Shuffle 2 of the other cards from your hand into your deck in order to draw a card.'],
    number: '83',
    artist: 'Keiji Kinebuchi',
    rarity: 'Uncommon',
    legalities: {
  ...
  },
  {
    ...
    name: 'Pokédex',
    supertype: 'Trainer',
    rules: ['Look at up to 5 cards from the top of your deck and rearrange them as you like.'],
    number: '87',
    artist: 'Keiji Kinebuchi',
    rarity: 'Uncommon',
    legalities: {
  ...
  },
  {
    ...
    name: 'Energy Removal',
    supertype: 'Trainer',
    rules: ["Choose 1 Energy card attached to 1 of your opponent's Pokémon and discard it."],
    number: '92',
    artist: 'Keiji Kinebuchi',
    rarity: 'Common',
    legalities: {
  ...
  },
  {
    ...
    supertype: 'Energy',
    subtypes: ['Special'],
    rules: ["Provides ColorlessColorless energy.\nDoesn't count as a basic Energy card."],
    number: '96',
    artist: 'Keiji Kinebuchi',
    rarity: 'Uncommon',
    legalities: {
